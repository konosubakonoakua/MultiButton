...
//=======================NRF24L01_CE端口=========================================
#define  nRF24L01_CE_0        HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_RESET)        
#define  nRF24L01_CE_1        HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_SET)      
//=============================RF24L01_CSN端口==================================
#define  nRF24L01_CSN_0       HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0, GPIO_PIN_RESET)          
#define  nRF24L01_CSN_1       HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0, GPIO_PIN_SET)     
//=============================RF24L01_SCK端口======================================
#define  nRF24L01_SCK_0       HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_RESET)     
#define  nRF24L01_SCK_1       HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_SET)    
//=============================RF24L01_MISO端口=========================================
#define  nRF24L01_MISO_IN     	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_5)
//============================= RF24L01_MOSI端口================================
#define  nRF24L01_MOSI_0      HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, GPIO_PIN_RESET)
#define  nRF24L01_MOSI_1      HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, GPIO_PIN_SET)
//==========================IRQ状态============================================
#define  nRF24L01_IRQ_IN      	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4)
//==========================电源控制端口============================================
...
//=======================NRF24L01_CE端口=========================================
#define  nRF24L01_CE1_0        HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_RESET)        
#define  nRF24L01_CE1_1        HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_SET)      
//=============================RF24L01_CSN端口==================================
